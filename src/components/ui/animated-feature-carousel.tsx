                    ...
                    return (
                        <motion.li key={step.name} initial="inactive" animate={isCurrent ? "active" : "inactive"} variants={stepVariants} transition={{ duration: 0.3 }} className="relative" >
                            <button
                                type="button"
                                className={cn(
                                    "group flex items-center gap-2.5 rounded-full px-3.5 py-1.5 text-sm font-medium transition-colors duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500 dark:focus-visible:ring-offset-black",
                                    isCurrent 
                            ...
                            >
                                <span className={cn(
                                    ...
                                    isCompleted 
                                        ? "bg-blue-600 text-white dark:bg-blue-500" 
                                        : isCurrent 
                                            ? "bg-blue-400 text-blue-900 dark:bg-blue-400 dark:text-blue-900" 
...
export function FeatureCarousel({
  ...
  return (
    <div className="flex flex-col gap-12 w-full max-w-6xl mx-auto p-4">
